type FormatEvmExplorerBlockOptions = {
	path?: string;
};
 ...
 */
const formatEvmExplorerBlock = (
	evmExplorerUrl?: string | null,
	block?: number | null,
	options: FormatEvmExplorerBlockOptions = {},
): string => {
...
export { formatEvmExplorerBlock, type FormatEvmExplorerBlockOptions };
